 ...
 * @brief Define a namespace for the binary expression structure.
 */
typedef binary_expression_t bound_declaration_expression_t;

/**
 * @brief Define a namespace for the binary expression structure.
 */
typedef binary_expression_t bound_number_expression_t;

/**
 * @brief Define a namespace for the binary expression structure.
 */
typedef binary_expression_t bound_integer_expression_t;

/**
 * @brief Define a namespace for the binary expression structure.
 */
typedef binary_expression_t bound_boolean_expression_t;
